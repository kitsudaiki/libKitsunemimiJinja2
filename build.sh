...
get_required_kitsune_lib_repo "libKitsunemimiJson" "v0.11.0" 1 "staticlib"

#-----------------------------------------------------------------------------------------------------------------

if [ $1 = "test" ]; then
    build_kitsune_lib_repo "libKitsunemimiJinja2" 1 "staticlib run_tests"
else
    build_kitsune_lib_repo "libKitsunemimiJinja2" 1 "staticlib"
fi
